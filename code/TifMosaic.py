...
#test结果Mosaic生成文件路径
path = r"D:\2020SentinelData\predictionImages\Gaofen_9bands_256_118model_20210611\118_tif"
os.chdir(path)
mosaic_file_name = 'Gaofen_9bands_2021_1_256_new_Mosaic.tif'

# 20190403T50SKD4.tif 20190403T50SKD5.tif
# 20200417T50SKD5.tif 20200417T50SKD6.tif
# 20200417T50SKE1.tif 20200417T50SKE2.tif 20200417T50SKE3.tif
...
#获取所有结果的tif文件
in_files = glob.glob(r"D:\2020SentinelData\predictionImages\Gaofen_9bands_256_118model_20210611\118_tif\2021_1_new\*.tif") #GF6_1
in_fn = in_files[0]
#获取待镶嵌栅格的最大最小的坐标值

...
if __name__ == '__main__':
    EPOCHES = 100
    BATCH_SIZE = 16
    image_paths = glob.glob(r'D:\2020SentinelData\GFDATA\clipSize\4bands_imagelabel_512\*.tif')
    label_paths = glob.glob(r'D:\2020SentinelData\GFDATA\clipSize\4bands_imagelabel_512\*.png')
    ...
    model_path = "../user_data/model_data/unetplusplus_regnetY118"
    if(upsample):
        model_path += "_upsample"
    if(addNDVI):
        model_path += "_ndvi"
    model_path += "_" + loss
    swa_model_path = model_path + "_lsce_dc_loss.pth"
    model_path += ".pth"
    early_stop = 10
